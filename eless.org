# Time-stamp: <2018-02-16 15:14:27 kmodi>
...
- At the end of it all, switch to the =eless-first-buffer= (if
  non-nil), and maximize the window so that only that buffer is shown.
#+begin_src emacs-lisp
