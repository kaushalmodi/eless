# Time-stamp: <2017-05-03 13:29:57 kmodi>
...
|-------+-------------------------------------------------------|
| -h    | Show this help (--help will show emacs help) and quit |
...
#+BEGIN_SRC text :tangle no :noweb-ref source-link
...
do
    ...
    then
        echo "Eless Version <<version>> (<<source-link>>/tree/<<version>>)"
        exit 0
    elif [[ "${var}" == '-' ]]
    then
