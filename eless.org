# Time-stamp: <2019-07-31 11:04:45 kmodi>
...
# that works with info 6.5.  Apparently the string in the first line of
# info-returned buffer changed in info 6.5.
if [[ -z ${info_man} ]]
then
    # The first line of Info manuals can also be the below:
    #   - Begin with "File:", and
    #   - Contain "Node:"
    # Example: "File: emacs,  Node: Top,  Next: Distrib,  Prev: (dir),  Up: (dir)"
    info_man=$(echo "${first_line_piped_data}" \
